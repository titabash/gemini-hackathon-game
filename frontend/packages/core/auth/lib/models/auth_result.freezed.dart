...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResult<T>);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( AuthException exception)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( AuthException exception)  failure,}) {final _that = this;
switch (_that) {
case _Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( AuthException exception)?  failure,}) {final _that = this;
switch (_that) {
case _Success() when success != null:
return success(_that.data);case _Failure() when failure != null:
return failure(_that.exception);case _:
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $AuthResultCopyWith<T, $Res> {
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $AuthResultCopyWith<T, $Res> {
