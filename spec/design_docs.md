...
* 現在地の簡易マップ、PC/NPCの位置、注目対象のハイライト
* 視線誘導（誰が話しているか、危険が迫っているか）を短い演出で支援
...
* PC/NPCの位置表示（点/アイコンで十分）
* 現在地の雰囲気（簡易背景）
* 注目対象のハイライト
* 軽いアニメーション（近づく/逃げる/注視）

### 8.2 Flameでやらないこと（MVP）
...
* **左/上：Flame盤面**：PC/NPCの位置アイコン、注目対象のハイライト、軽い演出（近づく/視線/物音）
...
* **Flame**：倉庫エリア表示、見張りNPCを点で表示、ライト範囲を薄く
* **GenUI（Choice）**：
